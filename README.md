...
| Merged | `Yuan1z0825/nature-skills` (44.6k stars) | [#68](https://github.com/Yuan1z0825/nature-skills/pull/68) | Add direct Claude Code plugin install path |
| Merged | `wanshuiyin/Auto-claude-code-research-in-sleep` (16.7k stars) | [#291](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/pull/291) | Improve Codex MCP large payload handling |
...
| Closed | `Fission-AI/OpenSpec` (70.4k stars) | [#1186](https://github.com/Fission-AI/OpenSpec/pull/1186) | Support workspace planning homes and nested delta specs |
