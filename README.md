...
<p align="center">
  <a href="https://github.com/mem0ai/mem0/pull/5524"><img alt="mem0ai/mem0 Merged PR" src="https://img.shields.io/static/v1?label=Merged&message=mem0ai%2Fmem0+%E2%AD%90+65.0k&color=2ea44f&style=for-the-badge&logo=github" /></a>
...
| --- | --- | --- | --- |
| Merged | `mem0ai/mem0` (65.0k stars) | [#5524](https://github.com/mem0ai/mem0/pull/5524) | Preserve empty Azure AI Search update values |
...
| Merged | `Yuan1z0825/nature-skills` (40.4k stars) | [#68](https://github.com/Yuan1z0825/nature-skills/pull/68) | Add direct Claude Code plugin install path |
...
| In review | `vllm-project/vllm` (91.4k stars) | [#45494](https://github.com/vllm-project/vllm/pull/45494) | Clarify NIXL KV transfer stats semantics |
...
| Closed | `Fission-AI/OpenSpec` (67.8k stars) | [#1186](https://github.com/Fission-AI/OpenSpec/pull/1186) | Support workspace planning homes and nested delta specs |
