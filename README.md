...
| Merged | `Yuan1z0825/nature-skills` (28.3k stars) | [#68](https://github.com/Yuan1z0825/nature-skills/pull/68) | Add direct Claude Code plugin install path |
| Merged | `wanshuiyin/Auto-claude-code-research-in-sleep` (13.4k stars) | [#291](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep/pull/291) | Improve Codex MCP large payload handling |
| In review | `vllm-project/vllm` (86.1k stars) | [#45494](https://github.com/vllm-project/vllm/pull/45494) | Clarify NIXL KV transfer stats semantics |
...
| Approved | `Fission-AI/OpenSpec` (60.5k stars) | [#1186](https://github.com/Fission-AI/OpenSpec/pull/1186) | Support workspace planning homes and nested delta specs |
